...
from chem_mcmc.potentials import LogGaussianOpt, LogGaussian, Constant, Cuadratic
...
#potential = LogGaussian(A=[2., 0.8], mu=[4, 8])
potential = Cuadratic(k=0.1)
# Loggaussianopt doesn't work properly it outputs a veeery small trajectory 
# for some reason, check it !
p_group = ParticleGroup.random_square(number=15, lower=lower, upper=upper, dimension=2, kind='r')
